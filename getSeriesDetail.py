...
def fetch_series_detail(series_id):
    ...
    headers = {
        ...
        'authorization': authorization  # Authorization header now includes 'Bearer'
    }
    ...
    save_image(horizontal_url, os.path.join(title, "ThumbnailImage.png"))

    thumbnail_uri_template = series["thumbnailUriTemplate"]
    thumbnail_url = thumbnail_uri_template.format(height=100000, width=100000)
    save_image(thumbnail_url, os.path.join(title, "ThumbnailImage_little.png"))
